...
class Basket extends Component {
  constructor(props) {
    super(props);
    (this.sweetalertfunction = this.sweetalertfunction.bind(this)), (this.state = { value: '' });
  }
  sweetalertfunction() {
        ...
        <BasketStyle>
          <div className="wrapper">
            ...
            <div className="right">
              <h4 className="img">
                <span>
                  <img src={require('../../assets/basket.png')} alt="" height="21" width="21" />{' '}
                  Basket{' '}
                </span>
              </h4>
              ...
              <table rules="all">
                ...
                {JSON.parse(localStorage.getItem('basketItems')).map(item => {
                  return (
                    <tr>
